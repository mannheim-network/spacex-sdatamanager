...
All Requests to seal coordinator will include below http headers.
   ...
   2. Authorization: auth header, currently sdatamanager only supports bear token headers
...
## Seal Reason
Currently sdatamanager supports below reasons, the implementation should choose the approciate reason.
